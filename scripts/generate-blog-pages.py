...
BODY_LINKS: list[tuple[str, str, str | None]] = [
    ...
    ("brain surgery recovery timeline", "blog/brain-surgery-recovery-timeline/", "brain-surgery-recovery-timeline"),
    ("fatigue after brain surgery", "blog/fatigue-after-brain-surgery/", "fatigue-after-brain-surgery"),
    ("return to work after brain surgery", "blog/brain-surgery-recovery-timeline/", "brain-surgery-recovery-timeline"),
